...
class WebotsSkidSteerNode(WebotsNode):
    """
    ...
    def __init__(self,
        ...
        back_left_joint_param = self.declare_parameter('back_left_joint', back_left_joint)
        back_right_joint_param = self.declare_parameter('back_right_joint', back_right_joint)
        back_left_encoder_param = self.declare_parameter('back_left_encoder', back_left_encoder)
        back_right_encoder_param = self.declare_parameter('back_right_encoder', back_right_encoder)
        ...
        self.back_left_motor = self.robot.getMotor(back_left_joint_param.value)
        self.back_right_motor = self.robot.getMotor(back_right_joint_param.value)
        ...
        self.back_left_wheel_sensor = self.robot.getPositionSensor(back_left_encoder_param.value)
        self.back_right_wheel_sensor = self.robot.getPositionSensor(back_right_encoder_param.value)
    ...
    def _cmd_vel_callback(self, twist):
        ...
        self.back_left_motor.setVelocity(left_omega)
        self.back_right_motor.setVelocity(right_omega)
...
def main(args=None):
    ...
    differential_drive = WebotsSkidSteerNode(webots_robot_name, args=args)
